...
ImageResize.IMAGE_DATA_TYPE_BASE64 = "base64Image";
ImageResize.IMAGE_DATA_TYPE_URL = "urlImage";
ImageResize.RESIZE_TYPE_FACTOR = "factorResize";
ImageResize.RESIZE_TYPE_MIN_PIXEL = "minPixelResize";
ImageResize.RESIZE_TYPE_MAX_PIXEL = "maxPixelResize";
ImageResize.FORMAT_JPG = "jpg";
ImageResize.FORMAT_PNG = "png";
 ...
 */
ImageResize.prototype.resizeImage = function(success, fail, imageData, width, height, options) {
    ...
    var params = {
        ...
        format: options.format ? options.format : ImageResize.FORMAT_JPG,
        imageDataType: options.imageDataType ? options.imageDataType : ImageResize.IMAGE_DATA_TYPE_URL,
        resizeType: options.resizeType ? options.resizeType : ImageResize.RESIZE_TYPE_MAX_PIXEL,
 ...
 */
ImageResize.prototype.getImageSize = function(success, fail, imageData, options) {
    if (!options) {
        options = {};
    }
...
window.imageResize = new ImageResize();
